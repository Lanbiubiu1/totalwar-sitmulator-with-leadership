    ...
    public class FleeFromEnemies : MonoBehaviour
    {
        ...
        public IEnumerator Start()
        {
            ...
            while (true)
            {
                ...
                if (map.SearchForValueWithRandomStartingPoint(0.5f, SearchCondition.Greater, myMapPosition, 20, out _))
                {
                    if (map.SearchForValueWithRandomStartingPoint(0.5f, (flee) ? SearchCondition.Less : SearchCondition.Greater, myMapPosition, 15, out Vector2Int safeCell))//find safe place in range of 5
                    {
